...
echo "🚀 Démarrage du déploiement du Learning Streak Bot sur AWS EC2..."
...
sudo apt install -y python3-pip python3-venv git libpq-dev python3-dev build-essential curl wget
...
if [ -d "$PROJECT_DIR" ]; then
    ...
    echo -e "${YELLOW}URL du repository GitHub (ou laissez vide pour créer le dossier manuellement) :${NC}"
    read REPO_URL
    if [ -n "$REPO_URL" ]; then
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
success "🎉 Déploiement terminé avec succès sur AWS EC2 !"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "📊 Statut du bot :"
...
echo ""
echo "  • Créer le script de sauvegarde :"
echo "    ${GREEN}nano ~/backup_db.sh${NC}"
echo ""
echo "  • Programmer les sauvegardes (tous les jours à 3h) :"
echo "    ${GREEN}crontab -e${NC}"
echo "    Ajouter : ${YELLOW}0 3 * * * /home/$USER/backup_db.sh${NC}"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "✨ Votre bot Discord est maintenant opérationnel 24/7 sur AWS EC2 !"
echo ""
